...
if __name__ == '__main__':
    ...
    api_key = "%APIKEY%"
    scrap_url = f"http://api.scraperapi.com?api_key={api_key}&url=" + url

    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.61 Safari/537.36',
        'Accept': 'https://www.kinopoisk.ru/top/navigator/m_act[years]/1990%3A2020/m_act[rating]/1%3A/m_act[budget]/5%3A/m_act[is_film]/on/order/rating/page/1/#results',
    ...
    while True:
        r = requests.get(scrap_url.format(movie_id))
